...
(function () {
  ...
  modal.innerHTML = `
    ...
    ">
      <h3 style="margin:0 0 10px;color:#ffd6d6;"> 📦 Bulk Learning (100+ / 1000+ प्रश्न) </h3>
      <div style="display:flex;gap:10px;flex-wrap:wrap;margin-bottom:10px;">
        <input id="bulkSubject" placeholder="नया विषय लिखें या नीचे से चुनें" style="
          flex:1;
          padding:10px;
          border-radius:10px;
      ...
      <div style="font-size:12px;color:#ccc;margin-bottom:6px;"> फॉर्मेट (हर प्रश्न–उत्तर के बीच एक खाली लाइन): <br>
        <code> Q: प्रश्न...?<br> A: उत्तर... </code>
      </div>
      <textarea id="bulkInput" placeholder="यहाँ 100+ / 1000+ प्रश्नोत्तर पेस्ट करें…" style="
        width:100%;
        min-height:220px;
        padding:10px;
        border-radius:12px;
      ...
      <div style="display:flex;gap:8px;margin-top:10px;justify-content:space-between;flex-wrap:wrap;">
        <div id="bulkInfo" style="font-size:12px;color:#9fdf9f;"> अभी कोई डेटा सेव नहीं हुआ </div>
        <div>
  ...
  if (openBtn) {
    openBtn.onclick = () => {
      ...
      document.getElementById("bulkInfo").textContent = "Bulk मोड तैयार है";
    };
  }
  ...
  document.getElementById("loadSubjects").onclick = async () => {
    ...
    if (!subjects.length) {
      box.innerHTML = "<div style='color:#aaa;'>कोई विषय उपलब्ध नहीं है।</div>";
      return;
    }
    subjects.forEach(s => {
